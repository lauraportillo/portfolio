    ...
    <article className="about">
      ...
      <section className="section2">
        <p className="section2__text">
          ...
          to fit pieces, move them and adjust them. Admired by technology I embark on this journey as front end
          developer, where again I have to build, structure, fit and move code, communicating with machines. My
          experience working with multidisciplinary and international teams They have brought an open mind to interact
          with other cultures and work methods. I am a person creative, hard-working, I like to have everything under
          control, but if I don't get it, I look for solutions and ask for help if required. My biggest professional
          challenge has been to take this step towards reinvention, and to be part of the bootcamp from Adalab, which
          has given me the tools to continue on the path. Once here, I come ready to transfer all my skills to the world
          of technology. Upcoming goals: become an Architect squared, this time in the field of technology!
        </p>
        {/* <p className="section2__text">
